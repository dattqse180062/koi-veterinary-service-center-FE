...
import { fetchVetFeedbackDetails } from '../api/feedbackApi'
...
const FeedbackDetailPageForVeterinarian: React.FC = () => {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            if (feedbackId) {
                try {
                    const appointmentData = await fetchVetFeedbackDetails(feedbackId);
        ...
        <div className="container" style={{ marginTop: '2rem', textAlign: 'left' }}>
            ...
            <div className="card">
                <div className="card-body">
                    <div className="card-body">
                        <h5 className="card-title" style={{ width: '100%' }}>*Feedback ID: {feedback?.feedback_id}</h5>
                        ...
                        <h5 className="card-title" style={{ width: '100%' }}>*Current Status: {feedback?.appointment.current_status}</h5>
...
export default FeedbackDetailPageForVeterinarian;
