    ...
    return (
        <div className="container-fluid vh-100 d-flex justify-content-center align-items-center ">
            ...
            <div className="row w-100 h-100">
                {/* Image Section */}
                <div className="col-md-5 col-sm-12 d-flex flex-column justify-content-center align-items-center mb-4" style={{ marginTop: "6rem" }}>
                ...
                {/* Form Section */}
                <div className="col-md-7 col-sm-12 d-flex flex-column justify-content-center align-items-center" style={{ marginTop: "3.5rem" }}>
