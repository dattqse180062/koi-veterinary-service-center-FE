...
const FeedbackDetailPageForManager: React.FC = () => {
    ...
    const feedback_id : number = location.state?.feedbackId;
    ...
    useEffect(() => {
        const fetchFeedbackDetails = async () => {
            try {
                const response = await axios.get(`https://66fff3374da5bd2375529fe6.mockapi.io/api/v2/feedbackdetails/${feedback_id}`);
