        ...
        <section className="service-section py-5 bg-light">
            <div className="container py-5 bg-light">
                <div className="text-center">
                    <h2 className="fs-1 fw-bold" style={{ fontSize: '1.9rem', color: '#02033B', marginTop: "-25px", marginBottom: "50px" }}>Our Services</h2>
                </div>
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6 col-sm-7 d-flex justify-content-center mb-4">
                        <div className="card custom-card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title card-title-service">Online Consulting</h5>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-7 d-flex justify-content-center mb-4">
                        <div className="card custom-card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title card-title-service">Veterinary Hospital</h5>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-7 d-flex justify-content-center mb-4">
                        <div className="card custom-card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title card-title-service">At-Home Service</h5>
